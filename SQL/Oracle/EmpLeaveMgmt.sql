...
VALUES (5000001, 1, TO_DATE('2024-01-15', 'YYYY-MM-DD'), TO_DATE('2024-01-20', 'YYYY-MM-DD'), NULL, 'pending', 'Personal Work');

INSERT INTO LEAVE (EMP_ID, LEAVE_TYPE_ID, START_DATE, END_DATE, APPROVER_ID, STATUS, REASON)
VALUES (5000002, 2, TO_DATE('2024-02-20', 'YYYY-MM-DD'), TO_DATE('2024-02-22', 'YYYY-MM-DD'), 5000000, 'approved', 'Religious Holiday');
...
CREATE INDEX EMPLOYEE_HIRE_DATE_INDEX ON HR_EMP (HIRE_DATE);

SELECT FIRST_NAME || ' '  || LAST_NAME AS EMPLOYEE_NAME
FROM EMPLOYEE WHERE EXTRACT(DAY FROM HIRE_DATE) = 15;

-- CREATE INDEX FOR ABOVE QUERY 
CREATE INDEX EMPLOYEE_HIRE_DATE_INDEX ON EMPLOYEE (EXTRACT(DAY FROM HIRE_DATE));
